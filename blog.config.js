...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '7941658b0ee64a81871d6d9bff564f9c',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '人脉圈子（论坛、峰会、私享会、关系高端局）,包装资质（个人、产品、企业荣誉包装，高难度企业资质解决）,媒体宣传，其他特殊资质、证、牌、物🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '升维橙界', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '人脉圈子（论坛、峰会、私享会、关系高端局）,包装资质（个人、产品、企业荣誉包装，高难度企业资质解决）,媒体宣传，其他特殊资质、证、牌、物🎉', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.dazaoip.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '人脉圈子（论坛、峰会、私享会、关系高端局）,包装资质（个人、产品、企业荣誉包装，高难度企业资质解决）,媒体宣传，其他特殊资质、证、牌、物🎉', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'yujun2030@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || '', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'https://t.me/dazaoip', // 你的telegram 地址 例如 https://t.me/tangly_1024
  ...
  IMAGE_ZOOM_IN_WIDTH: process.env.NEXT_PUBLIC_IMAGE_ZOOM_IN_WIDTH || 900, // 文章图片点击放大后的画质宽度，不代表在网页中的实际展示宽度
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-ZPCQSTS00E', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  // 微软 Clarity 站点分析
  CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || 'lr4dvfurlr', // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合
  ...
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || '专注打造个人IP、企业IP、产品IP，人脉圈子（论坛、峰会、私享会、关系高端局）,包装资质（个人、产品、企业包装，企业资质）,媒体宣传，其他高难度特殊资质、证、牌、物', // 站点描述，被notion中的页面描述覆盖
